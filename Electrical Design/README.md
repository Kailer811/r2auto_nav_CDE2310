...
There is a "Flywheel control circuit" in the [`Schematic_Diagram_for_Electrical_Design.png`](Schematic_Diagram_for_Electrical_Design.png) . This circuit is the key circuit to control the on and off of the flywheel. 
